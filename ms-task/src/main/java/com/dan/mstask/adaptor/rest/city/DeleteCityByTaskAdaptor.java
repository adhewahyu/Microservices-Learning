...
public class DeleteCityByTaskAdaptor extends RestAdaptor<DeleteCityByTaskRequest, ValidationResponse> {

    @Value("${config.integration.ms-masterdata.delete-city-by-task}")
    private String deleteCityByTaskUrl;
    ...
    @Override
    public ValidationResponse execute(DeleteCityByTaskRequest request) {
        this.setEnableDebug(true);
        this.setHttpMethod(HttpMethod.POST);
        this.setRestTemplate(restClientEnhance);
        this.setUrl(deleteCityByTaskUrl);
        try{
    ...
    @Override
    protected EsbRequest generatePayload(DeleteCityByTaskRequest request) {
